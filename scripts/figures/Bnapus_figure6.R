...
gene_to_ids <- list()
gene_to_ids[["ABCG40"]] <- c("BnaA06g10230D", "BnaC05g11890D", "BnaA06g10230D--BnaC05g11890D")
gene_to_ids[["BBE4"]] <- c("BnaC05g20370D", "BnaA09g28890D", "BnaC05g20370D--BnaA09g28890D")
...
pdf(file = "plots/main/Figure6_qPCR_vs_RNAseq.pdf", width=12, height=6, onefile=FALSE)
