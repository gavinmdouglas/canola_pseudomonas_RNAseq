...
shoot_day5_down <- go_enrichment_barplot(go_enrichment_results$Shoot_down_day5,
                                       ...
                                       #go2ignore = c("GO:0019758", "GO:0019761"),
                                       x_max = 25)  

# Write out plots
pdf(file = "plots/main/Figure4_upregulated_GO.pdf", width=18, height=10, onefile=FALSE)
...
pdf(file = "plots/main/Figure5_downregulated_GO.pdf", width=18, height=10, onefile=FALSE)
plot_grid(root_day1_down, root_day5_down, shoot_day1_down, shoot_day5_down,
          nrow=2, ncol=2,
          labels=c('A', 'B', 'C', 'D'))
